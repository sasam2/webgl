...
// sliders for viewing parameters
    ...
    document.getElementById("thetaSlider").onchange = function() {
        theta = document.getElementById("thetaSlider").value* Math.PI/180.0;
    };
    document.getElementById("phiSlider").onchange = function() {
        phi = document.getElementById("phiSlider").value* Math.PI/180.0;
    };*/
    ...
    document.getElementById("fovSlider").onchange = function() {
        fovy = document.getElementById("fovSlider").value;
    };
